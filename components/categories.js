...
export default function Categories() {
  return (
    <section className="w-full px-4">
      <div className="max-w-6xl mx-auto rounded-[24px] bg-white shadow-lg border border-pink-100/40 p-6 sm:p-8 mb-8">
        ...
        <Swiper
          slidesPerView={2.2}
          spaceBetween={24} // ✨ espacio suave entre cards
          loop={true} // 🔁 loop activo
          autoplay={{
            delay: 2400,
            disableOnInteraction: false,
          }}
          speed={900} // 🌈 desplazamiento suave
          breakpoints={{
            640: { slidesPerView: 3.3, spaceBetween: 28 },
