...
const categories = [
  { name: "Seasonal & Holidays", emoji: "🎉", color: "bg-yellow-200", slug: "seasonal-holidays", keywords: ["holiday", "season", "party", "celebration", "zombie", "halloween"] },
  { name: "Birthday", emoji: "🎂", color: "bg-pink-200", slug: "birthdays", keywords: ["birthday", "cake", "celebrate", "happy", "zombie"] },
  { name: "Love", emoji: "💘", color: "bg-rose-200", slug: "love-romance", keywords: ["love", "romance", "heart", "affection", "zombie love"] },
  ...
  { name: "Kids & Teens", emoji: "🧸", color: "bg-purple-200", slug: "kids-teens", keywords: ["kids", "teens", "children", "fun", "zombie kids"] },
  { name: "Humor", emoji: "😄", color: "bg-rose-100", slug: "humor-memes", keywords: ["humor", "funny", "meme", "laugh", "zombie joke"] },
  { name: "Pets", emoji: "🐾", color: "bg-green-100", slug: "pets", keywords: ["pets", "animals", "dogs", "cats", "zombie dog"] },
  ...
  { name: "Friendship", emoji: "🤝", color: "bg-orange-100", slug: "friendship", keywords: ["friend", "companionship", "bond", "connection", "zombie friend"] },
  ...
  { name: "Custom & AI", emoji: "🤖", color: "bg-teal-100", slug: "custom-ai", keywords: ["ai", "custom", "artificial", "unique", "zombie art"] },
];
  ...
  return (
    <section id="categories" className="text-center py-14">
      ...
      <div className="flex justify-center mb-10">
        <input
          type="text"
          placeholder="Search — love, birthday, zombie, friendship..."
          value={search}
