    ...
    >
      ...
      >
        <video
          ...
          className="rounded-2xl shadow-lg object-contain bg-pink-50"
          style={{
            width: "100%",   // 🔹 Video ocupa 100% del ancho del contenedor
            height: "150%",  // 🔹 Video ocupa 100% del alto del contenedor
          }}
        />
      </div>
    </div>
