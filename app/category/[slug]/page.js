  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        // 🔹 Filtrar videos que pertenezcan a esta categoría (slug)
        ...
        // 🔹 Buscar subcategorías únicas dentro de esta categoría
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 mb-10 text-center">
        Discover Everwish cards and moments under this category ✨
      </p>

      {/* 🔍 Búsqueda */}
      <input
        type="text"
        placeholder="Search any keyword — e.g. yeti, christmas, love..."
        value={search}
