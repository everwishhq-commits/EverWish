...
export default function CategoriesPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-pink-50 pt-24 pb-16 px-6 text-center transition-all duration-500">
      {/* Título principal */}
      <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent drop-shadow-sm">
        Explore Categories 💌
      </h1>
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
        {categories.map((cat) => (
          <Link
            ...
            className="rounded-3xl bg-white shadow-md hover:shadow-xl hover:-translate-y-1 transition-all p-6 flex flex-col items-center justify-center border border-pink-100 active:scale-95"
          >
