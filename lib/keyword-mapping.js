/**
 * 🎯 MAPEO CON MÚLTIPLES CATEGORÍAS
...
export const KEYWORD_TO_SUBCATEGORIES = {
  ...
  // Zombie: Halloween + Birthday
  "zombie": ["Halloween", "Birthday Celebration"],
  "zombies": ["Halloween", "Birthday Celebration"],
  
  // Ghost: Halloween + Birthday
  "ghost": ["Halloween", "Birthday Celebration"],
  "ghosts": ["Halloween", "Birthday Celebration"],
  
  // Pumpkin: Halloween + Thanksgiving (decoración)
...
export function classifyByFilename(filename) {
  ...
  parts.forEach((part, index) => {
    ...
    const subcats = KEYWORD_TO_SUBCATEGORIES[keyword];
