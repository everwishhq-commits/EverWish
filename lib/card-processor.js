...
export async function processCard({
  ...
  try {
    ...
    const uniqueLink = `https://everwish.cards/view/${cardId}`;
  ...
  const response = await fetch('https://api.creatomate.com/v1/renders', {
    ...
    body: JSON.stringify({
      ...
      modifications: {
        ...
        'Video-Background': `https://everwish.cards/videos/${cardData.slug}.mp4`,
      },
    }),
  });
    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="https://everwish.cards/my-cards" style="display: inline-block; background: #8B5CF6; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; margin: 20px 0;">
            Ver mis tarjetas
          </a>
        </div>
      `,
