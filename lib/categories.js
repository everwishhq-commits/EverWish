...
export const MAIN_CATEGORIES = [
...

  {
    ...
    keywords: [
      ...
      "kiss", "forever", "date-night", "affection", "together",
    ],
  },

  {
    ...
    color: "#FFF7FF",
    keywords: [
      "birthday", "graduation", "babyshower", "genderreveal",
      "newhome", "newjob", "promotion", "retirement", "success",
      "mothersday", "fathersday", "teachersday", "familyday",
      "anniversaryparty", "congratulations", "milestone", "joy",
    ],
  },

  {
    ...
    keywords: [
      ...
      "achievement", "teamwork", "goal", "success", "dedication",
      "mentor", "leader", "teacher", "doctor", "nurse", "engineer",
      "artist", "coach", "athlete", "volunteer", "entrepreneur",
      "retirement", "colleague", "respect", "motivation", "skill", "effort",
    ],
  },
...

  {
    ...
    keywords: [
      ...
      "nature", "green", "planet", "eco", "flora", "fauna", "garden",
    ],
  },

  {
    ...
    color: "#FFFBE5",
    keywords: [
      "spring", "summer", "autumn", "fall", "winter", "rainy",
