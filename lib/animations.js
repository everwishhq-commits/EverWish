...
/* 🎨 Opciones relacionadas con cada tipo de tarjeta */
...
/* 🪄 Renderiza una sola animación seleccionada */
export function AnimationOverlay({ animation = "No animation" }) {
  ...
  // 🎯 Determinar emoji base según nombre
  const singleEmoji = (() => {
  ...
  // 🎬 Generar partículas (pocas y suaves)
  useEffect(() => {
    setKey(prev => prev + 1);
