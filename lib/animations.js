...
/* 🎨 Categorías principales de animaciones y sus variantes */
...
/* 🔹 Detecta la categoría según el slug */
export function getAnimationsForSlug(slug) {
  ...
  if (slug.includes("love") || slug.includes("heart") || slug.includes("kiss")) return "love";
  return "default";
}

/* 🌟 Capa de animaciones flotantes */
export function AnimationOverlay({ slug, animation }) {
  ...
  useEffect(() => {
    ...
    const newItems = Array.from({ length: total }, (_, i) => ({
      ...
      delay: Math.random() * 1.2, // entrada casi inmediata
      duration: Math.random() * 10 + 16, // más lento: 16–26s
