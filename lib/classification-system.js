/**
 * 🧠 SISTEMA DE CLASIFICACIÓN AUTO-APRENDIZAJE V11.2
 * - Distingue "animallovers" de "love"
 * - Soporta múltiples categorías (ej: zombie_halloween_birthday)
 * - ✨ NUEVO: Detecta TODAS las subcategorías (zombie → Halloween + Birthday)
    ...
    const subsWithVideos = subs
      .map(s => ({
        ...
        count: videos.filter(v => {
          // Buscar en todas las posibles ubicaciones de subcategorías
          const all = [
            v.subcategory, 
